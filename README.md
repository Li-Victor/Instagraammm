# Project 4 - Instagraammm

Instagraammm is a photo sharing app using Parse as its backend.
...
![](https://github.com/Li-Victor/Instagraammm/blob/master/1.gif)
...
- [Adorable Avatars](http://avatars.adorable.io/) - Cool Avatar Placeholder Service
- [Icon Master](https://iconmonstr.com/) - Thousands of free icons
- [Billabong Font](https://github.com/gabriensymons/fonts/blob/master/FONTS/Billabong%20(Instagram).ttf) - Font used to create the title
